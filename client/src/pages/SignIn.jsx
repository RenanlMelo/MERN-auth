...
export default function signIn() {
  ...
  return (
    <div className="bg-gray-950 z-0 absolute bg-cover bg-center bg-no-repeat top-0 w-screen h-screen flex justify-center items-center">
      <div className='absolute w-4/12 h-2/3 drop-shadow-4xl left-60 top-44 mix-blend-hard-light opacity-80'>
      ...
      <div className='p-6 max-w-xl w-1/2 h-3/6 bg-white bg-opacity-10 relative z-20 shadow-5xl rounded-2xl backdrop-blur-sm'>
        <h1 className="text-4xl text-center font-semibold my-7 pb-3 text-slate-200">Sign In</h1>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
          ...
          <input type="password" placeholder='Password' id='password' className='bg-zinc-800 text-slate-200 p-3 rounded-lg'onChange={handleChange}/>
            ...
            bg-indigo-950 rounded-md hover:scale-100 hover:ease-linear hover:duration-75 hover:bg-gray-900">{loading ? 'Loading...' : 'Sign In'}
            </button>
           <OAuth />
