    ...
    <div className="bg-gray-800  z-0 absolute bg-cover bg-center bg-no-repeat top-0 w-screen h-screen flex justify-center items-center">
      <div className='absolute w-4/12 h-2/3 drop-shadow-4xl left-60 top-20'>
        ...
        <path fill="url(#gradiente)" transform="translate(95 95)">
          <animate attributeName='d' dur='20000ms' repeatCount='indefinite' values='M38.5,-45.7C45.7,-31.2,44.6,-15.6,41.3,-3.3C38,9,32.6,18.1,25.3,28.1C18.1,38.2,9,49.3,-4.5,53.8C-18.1,58.4,-36.2,56.4,-52.4,46.3C-68.5,36.2,-82.7,18.1,-82.9,-0.2C-83.1,-18.5,-69.4,-37.1,-53.2,-51.5C-37.1,-66,-18.5,-76.4,-1.5,-74.9C15.6,-73.5,31.2,-60.2,38.5,-45.7Z;
      ...
      <div className='absolute w-4/12 h-2/3 drop-shadow-2xl right-96 bottom-0'>
        ...
        <path fill="url(#gradiente2)" transform="translate(85 85)">
          <animate attributeName='d' dur='20000ms' repeatCount='indefinite' values='M60.6,-55.4C76.7,-44.5,86.7,-22.3,85.5,-1.2C84.2,19.8,71.8,39.5,55.6,53.9C39.5,68.2,19.8,77.1,3.2,73.9C-13.5,70.8,-26.9,55.6,-40,41.2C-53.1,26.9,-65.9,13.5,-66.6,-0.7C-67.4,-14.9,-56.1,-29.9,-43,-40.8C-29.9,-51.7,-14.9,-58.6,3.7,-62.3C22.3,-66,44.5,-66.4,60.6,-55.4Z";
      ...
      <div className='p-6 max-w-xl w-1/2 h-3/6 bg-white bg-opacity-10 relative z-20 shadow-5xl rounded-2xl backdrop-blur-sm'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
          ...
          <input type="password" placeholder='Password' id='password' className='bg-slate-100 p-3 rounded-lg'onChange={handleChange}/>
            ...
            bg-gray-900 rounded-md duration-400 hover:scale-95 hover:ease-linear hover:duration-75 hover:bg-indigo-950">{loading? 'Loading...' : 'Submit'}
            </button>
