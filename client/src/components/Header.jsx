    ...
    <div className='bg-zinc-900 text-white mb-12 w-full absolute z-10 shadow-under'>
        <div className="flex justify-between items-center mas-w-6xl mx-auto p-8">
            ...
            <ul className='flex gap-9 text-2xl justify-center items-center'>
                <Link to='/'>
                    <li className='after:block after:content-[""] after:h-[2px] after:bg-white after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition after:duration-300 after:origin-center'>Home</li>
                </Link>
                <Link to='/about'>
                    <li className='after:block after:content-[""] after:h-[2px] after:bg-white after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition after:duration-300 after:origin-center'>About</li>
                </Link>
                <Link to='/profile'>
                    { currentUser ? (
